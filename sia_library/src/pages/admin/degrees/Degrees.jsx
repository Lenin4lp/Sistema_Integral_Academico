      ...
      <div className="  h-fit mt-10 md:mt-5 w-full flex justify-center items-center">
        <div className=" block">
          ...
          <div className=" mt-10 mx-2 lg:mx-10">
            <a href="/admin/carreras/registrar">
              <button className="relative block font-medium rounded bg-transparent px-3 py-1.5 text-[10px] sm:text-sm text-white border border-white hover:bg-white hover:text-[#1C274C] transition-all duration-300 ">
                Crear Carrera
              </button>
            </a>
          </div>
            ...
            {selectedDegree !== "" ? (
              <div className=" grid  grid-cols-1 md:grid-cols-4 lg:grid-cols-5">
                ...
                <div className=" mx-2 m-8 md:m-10 col-span-1 md:col-span-3 lg:col-span-4 flex  items-start">
                  <div className=" block">
                    <div className=" mb-10">
                      <a href={`/admin/carreras/${selectedDegree}`}>
                        <button className="relative block font-medium rounded bg-transparent px-3 py-1.5 text-[10px] sm:text-sm text-white border border-white w-fit hover:bg-[#146898] transition-all duration-300 ">
                          Modificar carrera
                        </button>
                      </a>
                    </div>
