        ...
        <div className=" block m-3">
          ...
          <div className=" flex justify-center items-center">
            <div className=" my-2 grid grid-cols-2">
              <div className=" mx-4">
                <button onClick={()=> removeUser(userId)} className=" p-2 active:transform active:scale-90 border border-white bg-[#ad2c2c] rounded-lg hover:bg-[#b94d4d] text-white hover:text-white text-[12px] md:text-sm lg:text-base duration-500">
                  Eliminar
                </button>
              </div>
              <div className=" mx-4">
      ...
      {content === 1 && (
        <div className=" h-fit block ml-1 lg:ml-10">
          ...
          <div className=" w-full flex justify-center items-center m-10">
            <button onClick={() => setOpen(true)} className=" p-2 active:transform active:scale-90 border border-white rounded-lg hover:bg-[#bb4a4a] text-white hover:text-white text-[13px] duration-500">
              Eliminar usuario
            </button>
          </div>
        </div>
