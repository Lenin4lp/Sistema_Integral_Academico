...
function Profile() {
  ...
  return (
    <div className=" overflow-x-hidden">
      <div className=" block">
        <div className=" pt-12 mb-5 md:mb-10 mx-7 flex items-center text-xl md:text-3xl font-bold text-white text-left">
              ...
              <div className=" m-3 block ">
                ...
                <div className=" mb-5">
                  {user && user.role_id === 1
                    ...
                    : teacher.group &&
                      teacher.group.filter((group) => group.group_status === 0).map((group) => (
                        <div
                          key={group.group_id}
                          className=" my-2 hover:text-[#146898]"
                        >
