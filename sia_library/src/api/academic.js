...
export const removeStudentFromGroup = (id, student_id) =>
  axios.delete(`/groups/${id}/students`, student_id);
...
export const deleteStudentFromGroup = (id, group) =>
  axios.delete(`/student/${id}/group`, group);